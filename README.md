...
```bash
bunx github:xxYaOho/my-island install --platform opencode
```
...
bunx github:xxYaOho/my-island upgrade --platform opencode
```
...
```bash
bunx github:xxYaOho/my-island uninstall --platform opencode
```
